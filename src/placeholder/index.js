...
Placeholder.FacebookStyle=FacebookStyle;
Placeholder.InstagramStyle=InstagramStyle;
Placeholder.BulletListStyle=BulletListStyle;
Placeholder.ListStyle=ListStyle;
Placeholder.CodeStyle=CodeStyle;
