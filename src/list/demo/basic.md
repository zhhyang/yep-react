        ...
        <ComponentCard title="长文本样式">
          <List renderHeader={() => 'Text Wrapping'} className="my-list">
            ...
            <Item extra="no arrow" arrow="empty" className="spe" wrap>
              In rare cases, the text of right side will wrap in the single line with long text. long text long text
              long text
            </Item>
          </List>
        </ComponentCard>

        <ComponentCard title="其他">
