  ...
  render() {
    return (
      ...
      <List renderHeader={() => 'Input Style'} className="my-list">
         ...
         <Item>
           <Button type="primary" size="small" inline onClick={()=> alert('Submit')}>Submit</Button>
           <Button size="small" inline style={{ marginLeft: '2.5px' }} onClick={()=> alert('Reset')}>Reset</Button>
         </Item>
      </List>
    </div>
    );
